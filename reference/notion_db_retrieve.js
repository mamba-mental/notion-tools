const obj = {
    ...
    last_edited_time: '2024-08-28T23:31:00.000Z',
    title: [
      {
        type: 'text',
    ...
    properties: {
      ...
      'YouTube Chapters': {
        ...
        formula: {
          expression: 'lets(\n' +
            '\tchapterMarkers, \n' +
            '\t{{notion:block_property:TBKn:00000000-0000-0000-0000-000000000000:191b1c83-1be7-4a60-80a2-6914a0773d1e}}.filter(current.{{notion:block_property:E%5E%5ET:1b178bc7-c10f-4283-9bdc-eefe9df54091:191b1c83-1be7-4a60-80a2-6914a0773d1e}}.includes("Chapter")).sort(current.{{notion:block_property:pXuZ:1b178bc7-c10f-4283-9bdc-eefe9df54091:191b1c83-1be7-4a60-80a2-6914a0773d1e}}).map(\n' +
            '\t\tcurrent.{{notion:block_property:pXuZ:1b178bc7-c10f-4283-9bdc-eefe9df54091:191b1c83-1be7-4a60-80a2-6914a0773d1e}}\n' +
            '\t\t\t.replace("^(.*?):\\d{2}$", "$1")\n' +
            '\t\t\t.replace("^00:(\\d{2}:\\d{2})","$1")\n' +
            '\t\t+ " - " + current.{{notion:block_property:title:1b178bc7-c10f-4283-9bdc-eefe9df54091:191b1c83-1be7-4a60-80a2-6914a0773d1e}}\n' +
            '\t),\n' +
            '\tif(\n' +
      ...
      'Pay Due Date': {
        ...
        formula: {
          expression: 'ifs(\n' +
            ...
            '\t\teomBuffer,\n' +
            '\t\tif(\n' +
            '\t\t\tsponsor.{{notion:block_property:N~dS:8930ea86-dd62-44f5-ba8a-15537496c1ad:191b1c83-1be7-4a60-80a2-6914a0773d1e}}.test("EOM"),\n' +
            '\t\t\tdateBetween(\n' +
            ...
            '\t\tnetBuffer,\n' +
            '\t\tifs(\n' +
            '\t\t\tsponsor.{{notion:block_property:N~dS:8930ea86-dd62-44f5-ba8a-15537496c1ad:191b1c83-1be7-4a60-80a2-6914a0773d1e}}.test("60"),\n' +
            '\t\t\t2,\n' +
            '\t\t\tsponsor.{{notion:block_property:N~dS:8930ea86-dd62-44f5-ba8a-15537496c1ad:191b1c83-1be7-4a60-80a2-6914a0773d1e}}.test("30"),\n' +
            '\t\t\t1,\n' +
            '\t\t\t0\n' +
            '\t\t),\n' +
            '\t\tifs(\n' +
            '\t\t\tsponsor.{{notion:block_property:N~dS:8930ea86-dd62-44f5-ba8a-15537496c1ad:191b1c83-1be7-4a60-80a2-6914a0773d1e}} == "On Deal Close" or sponsor.{{notion:block_property:N~dS:8930ea86-dd62-44f5-ba8a-15537496c1ad:191b1c83-1be7-4a60-80a2-6914a0773d1e}}.empty(),\n' +
            '\t\t\t"".parseDate(),\n' +
            '\t\t\tsponsor.{{notion:block_property:N~dS:8930ea86-dd62-44f5-ba8a-15537496c1ad:191b1c83-1be7-4a60-80a2-6914a0773d1e}} == "On Publish",\n' +
            '\t\t\t{{notion:block_property:hne%7C:00000000-0000-0000-0000-000000000000:191b1c83-1be7-4a60-80a2-6914a0773d1e}},\n' +
    ...
    parent: {
      type: 'block_id',
      block_id: 'd47b8017-f806-4fc9-881e-1e5ce9b7fbe3'
    },
    url: 'https://www.notion.so/26d43632ae044da5853b736531b3d40b',
    public_url: null,
    archived: false,
    in_trash: false,
    request_id: '0b2b7deb-c0be-4701-9cc4-9bdd1ea768c3'
  }